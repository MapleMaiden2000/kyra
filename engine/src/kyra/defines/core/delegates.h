...
typedef enum Delegate_Result {
    ...
    DELEGATE_MULTICAST_ERROR_DELEGATE_LISTENER_NULL                             = -204,
    DELEGATE_MULTICAST_ERROR_DELEGATE_SENDER_NULL                               = -205,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_ALLOCATE_MEMORY_FOR_STATE                = -206,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_DEALLOCATE_MEMORY_OF_STATE               = -207,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_ALLOCATE_MEMORY_FOR_DELEGATE             = -208,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_DEALLOCATE_MEMORY_OF_DELEGATE            = -209,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_CONSTRUCT_DELEGATE_MAP                   = -210,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_DESTRUCT_DELEGATE_MAP                    = -211,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_CONSTRUCT_ACTIVE_DELEGATES_ARRAY         = -212,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_DESTRUCT_ACTIVE_DELEGATES_ARRAY          = -213,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_DESTRUCT_DELEGATE_LISTENERS_ARRAY        = -214,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_DESTRUCT_DELEGATE_CALLBACKS_ARRAY        = -215,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_CONSTRUCT_ARRAYS_FOR_DELEGATE            = -216,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_REGISTER_DELEGATE                        = -217,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_LOCATE_DELEGATE_FOR_ID                   = -218,
    DELEGATE_MULTICAST_ERROR_FAILED_TO_LOCATE_LISTENER_FOR_ID                   = -219,
