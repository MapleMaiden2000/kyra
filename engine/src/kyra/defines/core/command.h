...
typedef enum Command_Module_Result {
    ...
    COMMAND_MODULE_ERROR_FAILED_TO_ALLOCATE_MEMORY_FOR_HISTORY_STACK            = -50,
    COMMAND_MODULE_ERROR_FAILED_TO_DEALLOCATE_MEMORY_OF_HISTORY_STACK           = -51,
    COMMAND_MODULE_ERROR_FAILED_TO_ALLOCATE_MEMORY_FOR_TEMP_BUFFER              = -52,
    COMMAND_MODULE_ERROR_FAILED_TO_DEALLOCATE_MEMORY_OF_TEMP_BUFFER             = -53,
